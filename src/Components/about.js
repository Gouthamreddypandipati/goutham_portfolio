...
const AboutPage = () => {
  const handleButtonClicked = () => {
    window.open('https://drive.google.com/file/d/1NJTe9MkirwVQqfoWW0nEvU84CviqPe41/view?usp=sharing', '_blank');
  };
  const DevhandleButtonClicked = () => {
    window.open('https://64c8a8c6ad29fb48bdcbc603--legendary-cobbler-e2d7a8.netlify.app/', '_blank');
  };
  ...
  const leetCodeIconClicked = () => {
    window.open('https://leetcode.com/GouthamReddyP/', '_blank');
  };
  ...
  const linkedInIconClicked = () => {
    window.open('https://www.linkedin.com/in/gouthamreddy-pandipati/', '_blank');
  };
  ...
  return (
    <HomePageContainer>
      <AboutContainer>
        <Name>Goutham Pandipati.</Name>
        <Subheading>Software Engineer</Subheading>
        <Paragraph>Innovation is my passion </Paragraph>
        ...
        <Svg>
          ...
          <StyledButton onClick={DevhandleButtonClicked}>DEVFOLIO</StyledButton>
        </Svg>
      </AboutContainer>
